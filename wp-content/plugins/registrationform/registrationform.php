<?php 
   ...
   */
   ...
   function show_form()
   {
      ...
      { 
         // Dit is een voorbeeld voor het afvuren van een willekeurige query op de database
         $result = $wpdb->query("SELECT * FROM `wp_users` WHERE `user_login` = '".$_POST['login']."' OR `user_email` = '".$_POST['email']."'");
         ...
         {
            echo "Uw loginnaam of e-mailadres is al in gebruik, kies een ander.";
            header("Refresh: 2; url=http://localhost/2016-2017/am1b/groenten/index.php/registratie-formulier/");
         }
